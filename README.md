...
| ⚡️ | **Fast**. Appropriate for filtering a list of thousands of items |
...
- Some very poor fuzzy matches are rejected by default (see _Fuzzy search strategies_)
...
This is split into two steps for performance (result of `createFuzzySearch`, which pre-processes `list`, can be cached).
...
If you use React or React Native, you can use these optional helpers:
...
const filteredList = useFuzzySearchList({
  ...
  // arbitrary mapping function, takes `FuzzyResult` as input
